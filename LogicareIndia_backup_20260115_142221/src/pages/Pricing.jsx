...
export default function Pricing() {
  ...
  const calculateEstimate = (e) => {
    ...
    const basePrice = (distanceNum * vehicle.rate * weightNum) / vehicle.minWeight;
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-accent-100 via-accent-50 to-primary-50 py-16 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600">
              Enter your shipment details to get an estimated price. Our team will provide a final quote after reviewing your requirements.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-1">
                {showEstimate && estimatedPrice ? (
                  <Card className="bg-gradient-to-br from-accent-500 to-primary-500 text-white border-0 shadow-xl">
                    <h3 className="text-xl font-bold text-white mb-4">Estimated Price</h3>
                    <div className="space-y-3 mb-6">
                      <div className="flex justify-between text-white/90">
                        <span>Base Price:</span>
                        <span className="font-semibold">₹{estimatedPrice.basePrice}</span>
                      </div>
                      <div className="flex justify-between text-white/90">
                        <span>Fuel Surcharge:</span>
                        <span className="font-semibold">₹{estimatedPrice.fuelSurcharge}</span>
                      </div>
                      <div className="flex justify-between text-white/90">
                        <span>GST (18%):</span>
                        <span className="font-semibold">₹{estimatedPrice.gst}</span>
                      </div>
                      <div className="border-t border-white/30 pt-3 flex justify-between text-lg font-bold text-white">
                        <span>Total:</span>
                        <span className="text-yellow-300">₹{estimatedPrice.total}</span>
                      </div>
                    </div>
                    <p className="text-sm text-white/80 mb-4">
                      * This is an estimated price. Final quote may vary based on actual requirements.
                    </p>
                    <Button variant="secondary" className="w-full bg-white text-accent-600 hover:bg-gray-100" onClick={() => window.location.href = '/contact'}>
                      Get Final Quote
                    </Button>
                  </Card>
                ) : (
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="bg-gradient-to-br from-accent-50 to-white border-2 border-accent-200">
                <h3 className="text-xl font-bold text-gray-900 mb-3">No Hidden Fees</h3>
                <p className="text-gray-600">
                  All charges are clearly displayed upfront. No surprises, no hidden costs.
                </p>
              </Card>
              <Card className="bg-gradient-to-br from-primary-50 to-white border-2 border-primary-200">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Volume Discounts</h3>
                <p className="text-gray-600">
                  Save more with volume-based pricing. Higher volumes = better rates.
                </p>
              </Card>
              <Card className="bg-gradient-to-br from-accent-50 to-white border-2 border-accent-200">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Flexible Plans</h3>
                <p className="text-gray-600">
                  Choose from pay-as-you-go or monthly subscription plans based on your needs.
                </p>
              </Card>
            </div>
          </div>
